...
bool Tree::treePolicy_(GameState& state, Ai* ai1, Ai* ai2)
{
	if(plays_ == -1)
		return wins_;
...
bool Tree::defaultPolicy_(GameState& state, Ai* ai1, Ai* ai2)
{
	if(state.isGameOver())
	{
...
double Tree::getUct_(int parentPlays, Player player) const
{
